...
public class CSVReader : MonoBehaviour
{
    ...
    void ReadCSV()
    {
        ...
        for(int i = 1; i < lines.Length; i++)
        {
            ...
            //cube.transform.localPosition = new Vector3(float.Parse(fields[0]), float.Parse(fields[1]), float.Parse(fields[2]));
            ...
            //Hip_Center.transform.TransformDirection(float.Parse(fields[2]), float.Parse(fields[3]), float.Parse(fields[4]));
