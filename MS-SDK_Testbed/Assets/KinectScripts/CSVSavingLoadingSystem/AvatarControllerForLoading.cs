...
public class AvatarControllerForLoading : MonoBehaviour
{
    ...
    protected void TransformBone(KinectWrapper.NuiSkeletonPositionIndex joint, int boneIndex, bool flip)
    {
