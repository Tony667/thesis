...
//				break;
	...
	void Awake()
	{
		...
		/*sphere00.transform.position = Vector3.zero; 
		sphere01.transform.position = Vector3.zero; 
		sphere02.transform.position = Vector3.zero; 
		sphere03.transform.position = Vector3.zero; 
		sphere04.transform.position = Vector3.zero; 
		sphere05.transform.position = Vector3.zero;*/ 
			...
			if(Player1Calibrated)
			{
				foreach (AvatarController controller in Player1Controllers)
				{
					//if(controller.Active)
					{
						...
						//GetRawSkeletonJointPos(Player1ID, 02); 
						//GetRawSkeletonJointPos(Player1ID, 03); 
						//GetRawSkeletonJointPos(Player1ID, 04); 
						//GetRawSkeletonJointPos(Player1ID, 05); 
						//GetRawSkeletonJointPos(Player1ID, 06); 
						//GetRawSkeletonJointPos(Player1ID, 07); 
						//GetRawSkeletonJointPos(Player1ID, 08); 
						//GetRawSkeletonJointPos(Player1ID, 09); 
						//GetRawSkeletonJointPos(Player1ID, 10); 
						//GetRawSkeletonJointPos(Player1ID, 11); 
						//GetRawSkeletonJointPos(Player1ID, 12); 
						//GetRawSkeletonJointPos(Player1ID, 13); 
						//GetRawSkeletonJointPos(Player1ID, 14); 
						//GetRawSkeletonJointPos(Player1ID, 15); 
						//GetRawSkeletonJointPos(Player1ID, 16); 
						//GetRawSkeletonJointPos(Player1ID, 17); 
						//GetRawSkeletonJointPos(Player1ID, 18); 
						//GetRawSkeletonJointPos(Player1ID, 19);

						
						//sphere00.transform.position = GetRawSkeletonJointPos(Player1ID, 03);
						//sphere01.transform.position = GetRawSkeletonJointPos(Player1ID, 04);
						//sphere02.transform.position = GetRawSkeletonJointPos(Player1ID, 05); 
						//sphere03.transform.position = GetRawSkeletonJointPos(Player1ID, 06); 
						//sphere04.transform.position = GetRawSkeletonJointPos(Player1ID, 08); 
						//sphere05.transform.position = GetRawSkeletonJointPos(Player1ID, 09); 
						//sphere06.transform.position = GetRawSkeletonJointPos(Player1ID, 10); 
						
						
						/*GetJointPosition(Player1ID, 00); 
						GetJointPosition(Player1ID, 01); 
						GetJointPosition(Player1ID, 02); 
						GetJointPosition(Player1ID, 03); 
						GetJointPosition(Player1ID, 04); 
						GetJointPosition(Player1ID, 05); 
						GetJointPosition(Player1ID, 06); 
						GetJointPosition(Player1ID, 07); 
						GetJointPosition(Player1ID, 08); 
						GetJointPosition(Player1ID, 09); 
						GetJointPosition(Player1ID, 10); 
						GetJointPosition(Player1ID, 11); 
						GetJointPosition(Player1ID, 12); 
						GetJointPosition(Player1ID, 13); 
						GetJointPosition(Player1ID, 14); 
						GetJointPosition(Player1ID, 15); 
						GetJointPosition(Player1ID, 16); 
						GetJointPosition(Player1ID, 17); 
						GetJointPosition(Player1ID, 18); 
						GetJointPosition(Player1ID, 19);

						
						sphere00.transform.position = GetJointPosition(Player1ID, 03);
						sphere01.transform.position = GetJointPosition(Player1ID, 04);
						sphere02.transform.position = GetJointPosition(Player1ID, 05); 
						sphere03.transform.position = GetJointPosition(Player1ID, 06); 
						sphere04.transform.position = GetJointPosition(Player1ID, 08); 
						sphere05.transform.position = GetJointPosition(Player1ID, 09); 
						sphere06.transform.position = GetJointPosition(Player1ID, 10); 
						
						Debug.Log("Hip Center coordinates" + GetJointPosition(Player1ID, 00)); 
						Debug.Log("Spine" + GetJointPosition(Player1ID, 01)); 
						Debug.Log("Shoulder Center" + GetJointPosition(Player1ID, 02)); 
						Debug.Log("Head coordinates" + GetJointPosition(Player1ID, 03)); 
						Debug.Log("Shoulder Left coordinates" + GetJointPosition(Player1ID, 04)); 
						Debug.Log("Elbow Left coordinates" + GetJointPosition(Player1ID, 05)); 
						Debug.Log("Wrist Left coordinates" + GetJointPosition(Player1ID, 06)); 
						Debug.Log("Hand Left coordinates" + GetJointPosition(Player1ID, 07)); 
						Debug.Log("Shoulder Right coordinates" + GetJointPosition(Player1ID, 08)); 
						Debug.Log("Elbow Right coordinates" + GetJointPosition(Player1ID, 09)); 
						Debug.Log("Wrist Right coordinates" + GetJointPosition(Player1ID, 10)); 
						Debug.Log("Hand Right coordinates" + GetJointPosition(Player1ID, 11)); 
						Debug.Log("Hip Left coordinates" + GetJointPosition(Player1ID, 12)); 
						Debug.Log("Knee Left coordinates" + GetJointPosition(Player1ID, 13)); 
						Debug.Log("Ankle Left coordinates" + GetJointPosition(Player1ID, 14)); 
						Debug.Log("Foot Left coordinates" + GetJointPosition(Player1ID, 15)); 
						Debug.Log("HipRight coordinates" + GetJointPosition(Player1ID, 16)); 
						Debug.Log("Knee Right coordinates" + GetJointPosition(Player1ID, 17)); 
						Debug.Log("Ankle Right coordinates" + GetJointPosition(Player1ID, 18)); 
						Debug.Log("Foot Right coordinates" + GetJointPosition(Player1ID, 19)); */
					}
				}
    ...
    private void JointPositions()
    {
        HipCenterCoordinates = GetJointPosition(Player1ID, 00);
        SpineCoordinates = GetJointPosition(Player1ID, 01);
        ShoulderCenterCoordinates = GetJointPosition(Player1ID, 02);
        HeadCoordinates = GetJointPosition(Player1ID, 03);
        ShoulderLeftCoordinates = GetJointPosition(Player1ID, 04);
        ElbowLeftCoordinates = GetJointPosition(Player1ID, 05);
        WristLeftCoordinates = GetJointPosition(Player1ID, 06);
        HandLeftCoordinates = GetJointPosition(Player1ID, 07);
        ShoulderRightCoordinates = GetJointPosition(Player1ID, 08);
        ElbowRightCoordinates = GetJointPosition(Player1ID, 09);
        WristRightCoordinates = GetJointPosition(Player1ID, 10);
        HandRightCoordinates = GetJointPosition(Player1ID, 11);
        HipLeftCoordinates = GetJointPosition(Player1ID, 12);
        KneeLeftCoordinates = GetJointPosition(Player1ID, 13);
        AnkleLeftCoordinates = GetJointPosition(Player1ID, 14);
        FootLeftCoordinates = GetJointPosition(Player1ID, 15);
        HipRightCoordinates = GetJointPosition(Player1ID, 16);
        KneeRightCoordinates = GetJointPosition(Player1ID, 17);
        AnkleRightCoordinates = GetJointPosition(Player1ID, 18);
        FootRightCoordinates = GetJointPosition(Player1ID, 19);
    }

    //public class JointPositions
    //{
    //    public KinectWrapper.NuiSkeletonPositionIndex HipCenterCoordinates = KinectWrapper.NuiSkeletonPositionIndex.HipCenter;
    //    public KinectWrapper.NuiSkeletonPositionIndex SpineCoordinates = KinectWrapper.NuiSkeletonPositionIndex.Spine;
    //    public KinectWrapper.NuiSkeletonPositionIndex ShoulderCenterCoordinates = KinectWrapper.NuiSkeletonPositionIndex.ShoulderCenter;
    //    public KinectWrapper.NuiSkeletonPositionIndex HeadCoordinates = KinectWrapper.NuiSkeletonPositionIndex.Head;
    //    public KinectWrapper.NuiSkeletonPositionIndex ShoulderLeftCoordinates = KinectWrapper.NuiSkeletonPositionIndex.ShoulderLeft;
    //    public KinectWrapper.NuiSkeletonPositionIndex ElbowLeftCoordinates = KinectWrapper.NuiSkeletonPositionIndex.ElbowLeft;
    //    public KinectWrapper.NuiSkeletonPositionIndex WristLeftCoordinates = KinectWrapper.NuiSkeletonPositionIndex.WristLeft;
    //    public KinectWrapper.NuiSkeletonPositionIndex HandLeftCoordinates = KinectWrapper.NuiSkeletonPositionIndex.HandLeft;
    //    public KinectWrapper.NuiSkeletonPositionIndex ShoulderRightCoordinates = KinectWrapper.NuiSkeletonPositionIndex.ShoulderRight;
    //    public KinectWrapper.NuiSkeletonPositionIndex ElbowRightCoordinates = KinectWrapper.NuiSkeletonPositionIndex.ElbowRight;
    //    public KinectWrapper.NuiSkeletonPositionIndex WristRightCoordinates = KinectWrapper.NuiSkeletonPositionIndex.WristRight;
    //    public KinectWrapper.NuiSkeletonPositionIndex HandRightCoordinates = KinectWrapper.NuiSkeletonPositionIndex.WristRight;
    //    public KinectWrapper.NuiSkeletonPositionIndex HipLeftCoordinates = KinectWrapper.NuiSkeletonPositionIndex.HipLeft;
    //    public KinectWrapper.NuiSkeletonPositionIndex KneeLeftCoordinates = KinectWrapper.NuiSkeletonPositionIndex.KneeLeft;
    //    public KinectWrapper.NuiSkeletonPositionIndex AnkleLeftCoordinates = KinectWrapper.NuiSkeletonPositionIndex.AnkleLeft;
    //    public KinectWrapper.NuiSkeletonPositionIndex FootLeftCoordinates = KinectWrapper.NuiSkeletonPositionIndex.FootLeft;
    //    public KinectWrapper.NuiSkeletonPositionIndex HipRightCoordinates = KinectWrapper.NuiSkeletonPositionIndex.HipRight;
    //    public KinectWrapper.NuiSkeletonPositionIndex KneeRightCoordinates = KinectWrapper.NuiSkeletonPositionIndex.KneeRight;
    //    public KinectWrapper.NuiSkeletonPositionIndex AnkleRightCoordinates = KinectWrapper.NuiSkeletonPositionIndex.AnkleRight;
    //    public KinectWrapper.NuiSkeletonPositionIndex FootRightCoordinates = KinectWrapper.NuiSkeletonPositionIndex.FootRight;
    //}
